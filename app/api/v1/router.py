...
api_router.include_router(attachments.item_attachments_router)
api_router.include_router(attachments.attachments_router)
api_router.include_router(requests.private_router)
api_router.include_router(audit.private_router)
